...
|                      UPSTREAM ROUTER                                   |
|                         routes                                         |
|    $prefixzero::1/64    $prefix:1::/52 via fe80::1000:0:0:0:1 dev swp1 |
|           fe80::1/64              or via $prefix:1000::1               |
+------+-----------------------------------------------------------------+
       |
       |                                           PrefixZero
+------+---+--------------------------------------------------------+
...
| |      fe80::1000:0:0:0:1/64                             | | GWPubLL 
| |   $prefix:1000:0:0:0:1/64                              | | GWPubIP6 , GWPubIP4
| |                                                        | |
| |                                                        | |
| | iface to-1abc-1               iface to-1123-1          | | GWtoEPName (ExitPoint's veth peer name)
| |    fe80::1000:1abc/64               fe80::1000:1123/64 | | GWtoEPLL (Gateway to ExitPoint Link-Local)
| | $prefix::1000:1abc/64            $prefix::1000:1123/64 | | GWtoEPPubIP6 /* is this needed? */
| |         +                            +                 | |
| +--------------------------------------------------------+ |
|           |                            |                   |
| +-----------------------+    +-----------------------+     |
...
+------------------------------------------------------------+
 ...
 $prefix:1abc::/64 via fe80::1abc dev to-1abc-1 
 $prefix:1123::/64 via fe80::1123 dev to-1123-1
...
TODO: 
  ...
  - for scaling on interfaces (number of macvlans can get quite big), we can switch to IPVLAN (maybe we should immediately)
