...
func (e Stellar) processReservationResources(resData workloads.ReservationData) (rsuFarmer rsuPerFarmer, freeToUse bool, err error) {
	freeToUse = true
	...
	return rsuPerFarmerMap, freeToUse, nil
}
