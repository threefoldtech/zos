...
func (p *testPool) Type() gridtypes.DeviceType {
	return p.ptype
}
...
func TestCreateSubvol(t *testing.T) {
	...
	_, err := mod.createSubvolWithQuota(500, "sub", gridtypes.SSDDevice)
...
func TestCreateSubvolUnlimited(t *testing.T) {
	...
	_, err := mod.createSubvolWithQuota(0, "sub", gridtypes.SSDDevice)
...
func TestCreateSubvolNoSpaceLeft(t *testing.T) {
	...
	_, err := mod.createSubvolWithQuota(20000, "sub", gridtypes.SSDDevice)
