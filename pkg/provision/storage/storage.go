...
func (b *BoltStorage) Capacity() (cap gridtypes.Capacity, active []gridtypes.Deployment, workloads int, err error) {
	twins, err := b.Twins()
	if err != nil {
		return gridtypes.Capacity{}, nil, 0, err
	}
