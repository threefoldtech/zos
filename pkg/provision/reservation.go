...
const (
	// NOTE: this value must be same as the one
	// defined in generated gedis stypes.
	// unfortunately we could not import them because
	// this will cause cyclic dependency :/
	// we will redefine them here until we find a
	// better solution.
	StateError ResultState = iota
	StateOk
	StateDeleted
)
