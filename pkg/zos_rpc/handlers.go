...
func (srv *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch in.Method {
	case "list_pets":
		req := new(ListPetsParams)
		err = ParamsToStruct(in.Params, req)
		if err == nil {
			out, err = srv.service.ListPets(req)
		}
	case "create_pet":
		req := new(CreatePetParams)
		err = ParamsToStruct(in.Params, req)
		if err == nil {
			out, err = srv.service.CreatePet(req)
		}
	case "get_pet":
		req := new(GetPetParams)
		err = ParamsToStruct(in.Params, req)
		if err == nil {
			out, err = srv.service.GetPet(req)
		}
	}
