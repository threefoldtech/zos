...
import (
	...
	"github.com/threefoldtech/zosbase/pkg/netbase/nft" // import network just for cleanup orphaned namespaces
	...
	"github.com/threefoldtech/zosbase/pkg/network/resource"
...
func action(cli *cli.Context) error {
	...
	rules.Close()
	_, err = network.CreateNDMZBridge()
	if err != nil { ///
