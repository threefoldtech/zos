...
func main() {
	...
	engine := provision.New(nodeID, source, localStore, remoteStore)
	...
	// report resource units to BCDB
	log.Info().Msg("sends resource units information to BCBD")
	//if err := store.Register(nodeID, *
}
