...
type IDStore interface {
	RegisterNode(node modules.Identifier, farm modules.Identifier) (string, error)
...
func (s *httpIDStore) RegisterNode(node modules.Identifier, farm modules.Identifier) (string, error) {
	buf := bytes.Buffer{}
